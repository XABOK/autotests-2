...
def test_list_users():
    ...
    status_code_list_users = reqres.list_users()[0]
    page_list_users = reqres.list_users()[1]
...
def test_single_user():
    ...
    status_code_single_user = reqres.single_user()[0]
    id_single_user = reqres.single_user()[1]
...
def test_single_user_not_found():
    ...
    status_code_single_user_not_found = reqres.single_user_not_found()
...
def test_list_resource():
    ...
    status_code_list_resource = reqres.list_resource()[0]
    url_list_resource = reqres.list_resource()[1]
    text_list_resource = reqres.list_resource()[2]
...
def test_single_resource():
    ...
    status_code_single_resource = reqres.single_resource()[0]
    id_single_resource = reqres.single_resource()[1]
...
def test_single_resource_not_found():
    ...
    status_code_single_resource_not_found = reqres.single_resource_not_found()
...
def test_create():
    ...
    status_code_create = reqres.create()[0]
    name_create = reqres.create()[1]
    job_create = reqres.create()[2]
...
def test_put_update():
    ...
    status_code_put_update = reqres.put_update()[0]
    name_put_update = reqres.put_update()[1]
    job_put_update = reqres.put_update()[2]
...
def test_patch_update():
    ...
    status_code_patch_update = reqres.patch_update()[0]
    name_patch_update = reqres.patch_update()[1]
    job_patch_update = reqres.patch_update()[2]
...
def test_delete():
    ...
    status_code_delete = reqres.delete()
    assert status_code_delete == 204, f"Неверный код ответа, получен {status_code_delete}"


def test_register_successful():
    """Проверка успешной регистрации"""
    status_code_register_successful = reqres.register_successful()[0]
    id_register_successful = reqres.register_successful()[1]
    token_register_successful = reqres.register_successful()[2]
...
def test_register_unsuccessful():
    ...
    status_code_register_unsuccessful = reqres.register_unsuccessful()[0]
    error_register_unsuccessful = reqres.register_unsuccessful()[1]
...
def test_login_successful():
    ...
    status_code_login_successful = reqres.login_successful()[0]
    token_login_successful = reqres.login_successful()[1]
...
def test_login_unsuccessful():
    ...
    status_code_login_unsuccessful = reqres.login_unsuccessful()[0]
    error_login_unsuccessful = reqres.login_unsuccessful()[1]
...
def test_delayed_response():
    ...
    status_code_delayed_response = reqres.delayed_response()[0]
    url_delayed_response = reqres.delayed_response()[1]
    text_delayed_response = reqres.delayed_response()[2]
